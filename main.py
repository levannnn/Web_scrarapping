...
def json_file(url):
    ...
    vacancy_tags = vacancies_list_tag.find_all(
        "div", class_="vacancy-serp-item-body")
    for tag in vacancy_tags:
        ...
        salary = (" ".join(salary_vacancy.text.split('\u202f'))
                  if salary_vacancy else "не указана")
        # название компании
        company_vacancy = tag.find(
